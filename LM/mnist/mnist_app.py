"""
-*- coding: utf-8 -*-
Created by lhy on 2021/4/30 12:47
Description:
"""
# coding:utf-8
...
import numpy as np
import os
from mnist import mnist_forward, mnist_backward
...
if __name__ == '__main__':
    ...
    for i in range(len(file)):
        png_name = "image/"+str(i)+'.png'
        testPicArr = pre_pic(png_name)
        preValue = restore_model(testPicArr)
        print("the real number is ",str(i))
